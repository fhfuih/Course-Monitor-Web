  ...
  render() {
    return (
      <main>
        ...
        <Typography variant="h3">Third Party</Typography>
        <Typography variant="p">
          ...
          <ul>
            <li>
              Google Analytics:
              <Link href="https://www.google.com/policies/privacy/partners/" target="_blank" rel="noopener">
        ...
        <Typography variant="h3">Online Privacy Policy Only</Typography>
        <Typography variant="p">
